...
HealthEducationFitParm_Low = BestParmExtract(HealthEducationResults_Low,HealthEducationParms_Low)
HealthEducationFitParm_Mid = BestParmExtract(HealthEducationResults_Mid,HealthEducationParms_Mid)
HealthEducationFitParm_High = BestParmExtract(HealthEducationResults_High,HealthEducationParms_High)

LocalFitParmameterValue['InitEconOutputGrowth_Low'] = HealthEducationFitParm_Low['InitEconOutputGrowth']
LocalFitParmameterValue['InitEconOutputGrowth_Mid'] = HealthEducationFitParm_Mid['InitEconOutputGrowth']
LocalFitParmameterValue['InitEconOutputGrowth_High'] = HealthEducationFitParm_High['InitEconOutputGrowth']
